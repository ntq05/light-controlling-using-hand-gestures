        ...
        if key == -1:
            ...
            if (is_handsign_character(key)):
                if (current_letter is None):
                    ...
                    print("Cannot switch character while recording, press the current character again to stop recording")
...
if __name__ == "__main__":
    LABEL_TAG = label_dict_from_config_file("Dataset/hand_gesture.yaml")
    data_path = 'Dataset/dataset'
    sign_img_path = 'Dataset/sign_img'
